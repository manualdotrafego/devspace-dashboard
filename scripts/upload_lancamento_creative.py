...
CICLOS = [
    ...
    (14,"24/06 - 30/06","2026-06-24","2026-06-30"),
    (15,"01/07 - 07/07","2026-07-01","2026-07-07"),
    (16,"08/07 - 14/07 (parcial)","2026-07-08","2026-07-08"),
]
...
# Thumbnails for all 3 campaigns
print("## THUMBSTART")
seen=set()
for cid in CAMPS:
    ...
    for ao in as_r.json().get('data', []):
        ads = requests.get(f"{BASE}/{ao['id']}/ads", params={
            ...
            'limit':100,'access_token':TOKEN}, timeout=30).json().get('data', [])
        for ad in ads:
